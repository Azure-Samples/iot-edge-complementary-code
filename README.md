...
|-------------------|--------------------------------------------|
| `csharp`          | Sample source code.                     |
| `images`            |
| `node`            |                                            |
| `.gitignore`      | Define what to ignore at commit time.      |
| `CODE_OF_CONDUCT.md`    | List of changes to the sample.             |
...
The Azure Functions development configuration is different for the .NET/C# and Node.js versions of this sample.  Refer to the instructions in the *README.md* files located in the _cloud_ folders in the Visual Studio code workspaces.
